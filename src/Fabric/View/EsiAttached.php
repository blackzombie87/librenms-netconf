...
/**
 * The devices hanging off an ESI-LAG, from core's own discovery rows (design doc
 * `docs/EVPN-FABRIC-UI.md`, plan §11 E3). Pure: it takes the ESI sides `EsiMatrix` already
