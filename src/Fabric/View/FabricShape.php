...
/**
 * What shape a fabric has, as three independent answers rather than one label (design doc
 * `docs/EVPN-FABRIC-UI.md`, plan §11 E1): the underlay template, where the routing happens,
